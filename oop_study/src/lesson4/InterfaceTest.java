...
interface Draw{
	public static final double PI = 3.141592;	// 정적 멤버, 상수
//	인터페이스는 변수 선언시 앞의 내용을 생략하면 public static final 을 컴파일러가 자동으로 붙여준다.
	int LIMIT = 1000;
	public abstract void move1();	// 추상 메서드
//	인터페이스는 메소드 선언시 앞의 내용을 생략하면 public abstract 을 컴파일러가 자동으로 붙여준다.
	void erase();
...
//	resize rotate erase move1 은 Draw 와 Graphic 의 메서드들
}
